<x-app-layout>
    <div class="mb-6">
        ...
        <p class="text-sm text-slate-600 mt-1">Użyj poniższego linku w cronie, aby uruchamiać zaplanowane kampanie i daily warming.</p>
    </div>
    ...
    <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
        ...
        <div>
            ...
            <p class="text-xs text-slate-500 mt-2">Uruchamiaj co minutę, aby wysyłać zaplanowane kampanie oraz kolejne porcje warmingu.</p>
        </div>
        <div class="pt-2">
